...
const Card = ({ title, footer, className = '', children }: CardProps) => {
  return (
    <div className={`rounded-lg border border-beige-200/70 bg-white/80 p-5 shadow-sm transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 dark:border-stone-800/70 dark:bg-stone-900/70 ${className}`}>
